    ...
    <div className="relative w-full h-[100dvh] md:min-h-screen overflow-hidden md:overflow-visible flex flex-col md:flex-row items-center justify-center pt-16 pb-20 md:pt-24 md:pb-40">
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-12 h-full md:h-auto items-center">
        ...
        >
          ...
          {/* RESTORED: Side-by-side buttons on mobile using flex-row */}
          <div className="flex flex-row gap-3 pt-2 w-full md:w-auto">
            <a 
        ...
        >
          ...
          <div className="relative w-[220px] h-[300px] md:w-[400px] md:h-[550px] z-10">
              ...
              {/* FLOATING CARDS */}
              <motion.div 
                style={{ x: typeof window !== 'undefined' && window.innerWidth > 768 ? cardX : 0, y: typeof window !== 'undefined' && window.innerWidth > 768 ? cardY : 0, z: 50 }} 
                animate={{ y: [0, -8, 0] }}
              ...
              >
                <motion.div animate={{ rotate: [0, 20, 0, 20, 0] }} transition={{ repeat: Infinity, duration: 2, repeatDelay: 1 }} className="text-xl md:text-3xl">👋</motion.div>
                <div><p className="text-xs md:text-base font-bold text-white">Namaste</p></div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2 md:gap-3">
                  ...
                  <div><p className="text-[10px] md:text-lg font-bold text-white">Scalable Tech</p></div>
                </div>
              </motion.div>
              ...
              >
                <div className="flex items-center gap-2 md:gap-3">
                    ...
                    <div><p className="text-[10px] md:text-lg font-bold text-white">Open to Work</p></div>
                </div>
              </motion.div>
          </div>
        </div>
