...
export default function Home() {
  ...
  return (
    <div className="relative w-full h-[100dvh] md:min-h-screen overflow-hidden md:overflow-visible flex flex-col md:flex-row items-center justify-center pt-24 pb-20 md:pt-24 md:pb-40">
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-12 h-full md:h-auto items-center">
        ...
        >
          {/* Location Badge - Pushed down on mobile to clear the header logo */}
          <div className="inline-flex items-center gap-2 px-2 py-1 md:px-3 md:py-1 rounded-full border border-cyan-500/30 bg-cyan-500/10 text-cyan-300 text-[10px] md:text-sm backdrop-blur-sm w-fit mt-40 md:mt-0">
             <MapPin size={12} className="text-cyan-400" />
             Hyderabad, India
          </div>

          <h1 className="text-4xl md:text-8xl font-bold leading-tight tracking-tight text-white">
